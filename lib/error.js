...
export const INVALID_RULE_INDEX_ERROR = {
    message: 'Cannot insert or delete rule at the specified index (negative, or greater than the last index)',
    name: 'IndexSizeError',
}
...
export const UPDATE_READONLY_STYLE_DECLARATION_ERROR = {
    message: 'Cannot change a read-only style declaration',
