...
// Generated from /var/www/packages/cssstyle/scripts/initial.js
...
module.exports = {
    ...
    'background-color': {
        initial: { type: new Set(['ident', 'keyword', 'color']), value: 'transparent' },
        value: '<color>',
    },
    'background-image': {
        initial: createList(
    ...
    'float': {
        initial: { type: new Set(['ident', 'keyword']), value: 'none' },
        value: 'block-start | block-end | inline-start | inline-end | snap-block | <snap-block()> | snap-inline | <snap-inline()> | left | right | top | bottom | footnote | none',
    },
    'float-defer': {
        initial: { type: new Set(['ident', 'keyword']), value: 'none' },
    ...
    'flood-color': {
        initial: { type: new Set(['ident', 'keyword', 'named-color', 'color']), value: 'black' },
        value: '<color>',
    },
    'flood-opacity': {
    ...
    'lighting-color': {
        initial: { type: new Set(['ident', 'keyword', 'named-color', 'color']), value: 'white' },
        value: '<color>',
    },
    'line-break': {
        initial: { type: new Set(['ident', 'keyword']), value: 'auto' },
    ...
    'stroke-color': {
        initial: createList(
            [
                { type: new Set(['ident', 'keyword', 'color']), value: 'transparent' },
            ],
            ',',
        ),
        value: '<color>#',
    ...
    'stroke-linejoin': {
        initial: createList(
            [
                { type: new Set(['ident', 'keyword']), value: 'miter' },
                { omitted: true, type: new Set([]) },
            ],
        ),
    ...
    'stroke-width': {
        initial: createList(
            [
                { type: new Set(['dimension', 'length', 'length-percentage']), value: 1 },
            ],
            ',',
        ),
        value: '<length-percentage>#',
