 ...
 *
 * A simple alias is a `-webkit-` prefixed property aliased to the corresponding
 * property without this prefix. All vendors must support these aliases.
 */
const simple = [
    'appearance', // TODO: report spec issue "`-webkit-appearance`, `-webkit-line-clamp`, and `-webkit-user-select` should be removed from existing specifications (or are missing in Compatibility)"
    'align-content',
    'align-items',
    'align-self',
    'animation',
    ...
    'flex-wrap',
    'justify-content',
    'line-clamp', // TODO: report spec issue "`-webkit-appearance`, `-webkit-line-clamp`, and `-webkit-user-select` should be removed from existing specifications (or are missing in Compatibility)"
    'mask',
    'mask-clip',
    'mask-composite',
    'mask-image',
    ...
    'user-select', // TODO: report spec issue "`-webkit-appearance`, `-webkit-line-clamp`, and `-webkit-user-select` should be removed from existing specifications (or are missing in Compatibility)"
]
