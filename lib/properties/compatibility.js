 ...
 */
const simple = [
    'appearance', // TODO: report spec issue "`appearance` is missing in CSS compatibility" (or to remove from the existing specification)
    'align-content',
    'align-items',
    'align-self',
    'animation',
    ...
    'flex-wrap',
    'justify-content',
    'line-clamp', // TODO: report spec issue "`line-clamp` is missing in CSS compatibility" (or to remove from the existing specification)
    'mask',
    'mask-clip',
    'mask-composite',
    'mask-image',
    ...
    'user-select', // TODO: report spec issue "`user-select` is missing in CSS compatibility" (or to remove from the existing specification)
]
