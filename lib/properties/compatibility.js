 ...
 */
const simple = [
    'appearance', // TODO: properties missing in CSS Compatibility (or to remove from the existing specification)
    'align-content',
    'align-items',
    'align-self',
    'animation',
    ...
    'flex-wrap',
    'justify-content',
    'line-clamp', // TODO: properties missing in CSS Compatibility (or to remove from the existing specification)
    'mask',
    'mask-clip',
    'mask-composite',
    'mask-image',
