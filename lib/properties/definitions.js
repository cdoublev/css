...
export default {
    ...
    'column-rule-edge-inset-end': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', 'column-rule-edge-inset-end'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'column-rule-edge-inset-start': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', 'column-rule-edge-inset-start'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'column-rule-interior-inset-end': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', 'column-rule-interior-inset-end'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'column-rule-interior-inset-start': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', 'column-rule-interior-inset-start'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'row-rule-edge-inset-end': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', 'row-rule-edge-inset-end'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'row-rule-edge-inset-start': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', 'row-rule-edge-inset-start'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'row-rule-interior-inset-end': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', 'row-rule-interior-inset-end'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'row-rule-interior-inset-start': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', 'row-rule-interior-inset-start'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
