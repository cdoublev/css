...
export default {
    ...
    'column-rule-inset-cap-end': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', 'column-rule-inset-cap-end'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'column-rule-inset-cap-start': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', 'column-rule-inset-cap-start'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'column-rule-inset-junction-end': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', 'column-rule-inset-junction-end'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'column-rule-inset-junction-start': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', 'column-rule-inset-junction-start'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'row-rule-inset-cap-end': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', 'row-rule-inset-cap-end'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'row-rule-inset-cap-start': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', 'row-rule-inset-cap-start'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'row-rule-inset-junction-end': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', 'row-rule-inset-junction-end'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'row-rule-inset-junction-start': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', 'row-rule-inset-junction-start'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
