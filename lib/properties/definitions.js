...
module.exports = {
    ...
    'float-offset': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', 'float-offset'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
                ...
                [
                    {
                        ...
                        start: 0,
                        types: ['<ident-token>', '<ident>', '<keyword>', '<generic-family-name>', '<generic-family>'],
                        value: 'monospace',
                    },
                ],
                ',',
    ...
    'inset-area': {
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'inset-area'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'position-anchor': {
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', '<anchor-element>', 'position-anchor'],
                value: 'implicit',
            },
            serialized: 'implicit',
        },
    ...
    'position-try-options': {
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'position-try-options'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'reading-order-items': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'reading-order-items'],
                value: 'normal',
            },
            serialized: 'normal',
        },
    ...
    'scroll-start-block': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'scroll-start-block'],
                value: 'auto',
            },
            serialized: 'auto',
        },
    ...
    'scroll-start-inline': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'scroll-start-inline'],
                value: 'auto',
            },
            serialized: 'auto',
        },
    ...
    'scroll-start-target-block': {
        animate: false,
        group: 'scroll-start-target',
        initial: {
            parsed: {
                end: 4,
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'scroll-start-target-block'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'scroll-start-target-inline': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'scroll-start-target-inline'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'scroll-start-target-x': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'scroll-start-target-x'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'scroll-start-target-y': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'scroll-start-target-y'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'scroll-start-x': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'scroll-start-x'],
                value: 'auto',
            },
            serialized: 'auto',
        },
    ...
    'scroll-start-y': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'scroll-start-y'],
                value: 'auto',
            },
            serialized: 'auto',
        },
