...
module.exports = {
    ...
    'anchor-default': {
        initial: {
            parsed: {
                ...
                type: new Set(['ident', 'keyword', 'anchor-element', 'anchor-default']),
                value: 'implicit',
            },
            serialized: 'implicit',
        },
    ...
    'anchor-scroll': {
        initial: {
            parsed: {
                representation: 'none',
                type: new Set(['ident', 'keyword', 'anchor-scroll']),
                value: 'none',
            },
            serialized: 'none',
        },
        ...
        initial: {
            parsed: createList(
                [
                    {
                        representation: 'currentcolor',
                        type: new Set(['ident', 'keyword', 'color']),
                        value: 'currentcolor',
                    },
                ],
                ',',
                new Set(['box-shadow-color']),
            ),
            serialized: 'currentcolor',
        },
        value: '<color>#',
    ...
    'box-shadow-position': {
        initial: {
            parsed: createList(
                [
                    {
                        representation: 'outset',
                        type: new Set(['ident', 'keyword']),
                        value: 'outset',
                    },
                ],
                ',',
                new Set(['box-shadow-position']),
            ),
            serialized: 'outset',
        },
        value: '[outset | inset]#',
                ...
                [
                    {
                        ...
                        type: new Set(['ident', 'custom-ident', 'keyword', 'generic-family']),
                        value: 'monospace',
                    },
                ],
                ',',
    ...
    'layout-order': {
        initial: {
            parsed: {
                representation: '0',
                type: new Set(['number', 'integer', 'layout-order']),
                value: 0,
            },
            serialized: '0',
        },
    ...
    'link-parameters': {
        initial: {
            parsed: {
                representation: 'none',
                type: new Set(['ident', 'keyword', 'link-parameters']),
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'overflow-block': {
        ...
        initial: {
            parsed: {
                representation: 'visible',
                type: new Set(['ident', 'keyword', 'overflow-block']),
                value: 'visible',
            },
            serialized: 'visible',
        },
    ...
    'overflow-clip-margin-block-end': {
        ...
        initial: {
            parsed: createList(
                ...
                ' ',
                new Set(['overflow-clip-margin-block-end']),
            ),
            serialized: '0px',
        },
        value: '<visual-box> || <length [0,∞]>',
    ...
    'overflow-clip-margin-block-start': {
        ...
        initial: {
            parsed: createList(
                ...
                ' ',
                new Set(['overflow-clip-margin-block-start']),
            ),
            serialized: '0px',
        },
        value: '<visual-box> || <length [0,∞]>',
    ...
    'overflow-clip-margin-bottom': {
        ...
        initial: {
            parsed: createList(
                ...
                ' ',
                new Set(['overflow-clip-margin-bottom']),
            ),
            serialized: '0px',
        },
        value: '<visual-box> || <length [0,∞]>',
    ...
    'overflow-clip-margin-inline-end': {
        ...
        initial: {
            parsed: createList(
                ...
                ' ',
                new Set(['overflow-clip-margin-inline-end']),
            ),
            serialized: '0px',
        },
        value: '<visual-box> || <length [0,∞]>',
    ...
    'overflow-clip-margin-inline-start': {
        ...
        initial: {
            parsed: createList(
                ...
                ' ',
                new Set(['overflow-clip-margin-inline-start']),
            ),
            serialized: '0px',
        },
        value: '<visual-box> || <length [0,∞]>',
    ...
    'overflow-clip-margin-left': {
        ...
        initial: {
            parsed: createList(
                ...
                ' ',
                new Set(['overflow-clip-margin-left']),
            ),
            serialized: '0px',
        },
        value: '<visual-box> || <length [0,∞]>',
    ...
    'overflow-clip-margin-right': {
        ...
        initial: {
            parsed: createList(
                ...
                ' ',
                new Set(['overflow-clip-margin-right']),
            ),
            serialized: '0px',
        },
        value: '<visual-box> || <length [0,∞]>',
    ...
    'overflow-clip-margin-top': {
        ...
        initial: {
            parsed: createList(
                ...
                ' ',
                new Set(['overflow-clip-margin-top']),
            ),
            serialized: '0px',
        },
        value: '<visual-box> || <length [0,∞]>',
    ...
    'overflow-inline': {
        ...
        initial: {
            parsed: {
                representation: 'visible',
                type: new Set(['ident', 'keyword', 'overflow-inline']),
                value: 'visible',
            },
            serialized: 'visible',
        },
    ...
    'overlay': {
        initial: {
            parsed: {
                representation: 'none',
                type: new Set(['ident', 'keyword', 'overlay']),
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'reading-order': {
        initial: {
            parsed: {
                representation: '0',
                type: new Set(['number', 'integer', 'reading-order']),
                value: 0,
            },
            serialized: '0',
        },
    ...
    'stroke-dashoffset': {
        initial: {
            parsed: {
                representation: '0',
                type: new Set(['number', 'stroke-dashoffset']),
                value: 0,
            },
            serialized: '0',
        },
    ...
    'text-autospace': {
        initial: {
            parsed: {
                representation: 'normal',
                type: new Set(['ident', 'keyword', 'text-autospace']),
                value: 'normal',
            },
            serialized: 'normal',
        },
    ...
    'text-box-edge': {
        initial: {
            parsed: {
                ...
                type: new Set(['ident', 'keyword', 'text-box-edge']),
                value: 'leading',
            },
            serialized: 'leading',
        },
    ...
    'text-box-trim': {
        initial: {
            parsed: {
                representation: 'none',
                type: new Set(['ident', 'keyword', 'text-box-trim']),
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'text-spacing-trim': {
        initial: {
            parsed: createList(
                ...
                ' ',
                new Set(['spacing-trim', 'text-spacing-trim']),
            ),
            serialized: 'space-first',
        },
    ...
    'view-transition-name': {
        initial: {
            parsed: {
                representation: 'none',
                type: new Set(['ident', 'keyword', 'view-transition-name']),
                value: 'none',
            },
            serialized: 'none',
        },
                    ...
                    createList(
                        [
                            ...
                            },
                            {
                                ...
                                type: new Set(['ident', 'custom-ident', 'keyword', 'gender']),
                                value: 'female',
                            },
                            {
                                omitted: true,
    ...
    'white-space-collapse': {
        initial: {
            parsed: {
                ...
                type: new Set(['ident', 'keyword', 'white-space-collapse']),
                value: 'collapse',
            },
            serialized: 'collapse',
        },
    ...
    'white-space-trim': {
        initial: {
            parsed: {
                representation: 'none',
                type: new Set(['ident', 'keyword', 'white-space-trim']),
                value: 'none',
            },
            serialized: 'none',
        },
