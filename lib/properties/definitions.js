...
export default {
    ...
    'align-self': {
        ...
        value: 'auto | <overflow-position>? [normal | <self-position>] | stretch | <baseline-position> | anchor-center',
    },
    'alignment-baseline': {
        initial: {
            parsed: {
    ...
    'border-block-end-clip': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'border-block-end-clip'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'border-block-start-clip': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'border-block-start-clip'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'border-bottom-clip': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'border-bottom-clip'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'border-bottom-left-radius': {
        ...
        initial: {
            parsed: list(
                ...
                ' ',
                ['<legacy-border-radius-syntax>', '<border-radius>', 'border-bottom-left-radius'],
            ),
            serialized: '0px',
        },
        value: '<border-radius>',
    ...
    'border-bottom-right-radius': {
        ...
        initial: {
            parsed: list(
                ...
                ' ',
                ['<legacy-border-radius-syntax>', '<border-radius>', 'border-bottom-right-radius'],
            ),
            serialized: '0px',
        },
        value: '<border-radius>',
    ...
    'border-end-end-radius': {
        ...
        initial: {
            parsed: list(
                ...
                ' ',
                ['<legacy-border-radius-syntax>', '<border-radius>', 'border-end-end-radius'],
            ),
            serialized: '0px',
        },
        value: '<border-radius>',
    ...
    'border-end-start-radius': {
        ...
        initial: {
            parsed: list(
                ...
                ' ',
                ['<legacy-border-radius-syntax>', '<border-radius>', 'border-end-start-radius'],
            ),
            serialized: '0px',
        },
        value: '<border-radius>',
    ...
    'border-inline-end-clip': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'border-inline-end-clip'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'border-inline-start-clip': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'border-inline-start-clip'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'border-left-clip': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'border-left-clip'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'border-right-clip': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'border-right-clip'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'border-start-end-radius': {
        ...
        initial: {
            parsed: list(
                ...
                ' ',
                ['<legacy-border-radius-syntax>', '<border-radius>', 'border-start-end-radius'],
            ),
            serialized: '0px',
        },
        value: '<border-radius>',
    ...
    'border-start-start-radius': {
        ...
        initial: {
            parsed: list(
                ...
                ' ',
                ['<legacy-border-radius-syntax>', '<border-radius>', 'border-start-start-radius'],
            ),
            serialized: '0px',
        },
        value: '<border-radius>',
    ...
    'border-top-clip': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'border-top-clip'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'border-top-left-radius': {
        ...
        initial: {
            parsed: list(
                ...
                ' ',
                ['<legacy-border-radius-syntax>', '<border-radius>', 'border-top-left-radius'],
            ),
            serialized: '0px',
        },
        value: '<border-radius>',
    ...
    'border-top-right-radius': {
        ...
        initial: {
            parsed: list(
                ...
                ' ',
                ['<legacy-border-radius-syntax>', '<border-radius>', 'border-top-right-radius'],
            ),
            serialized: '0px',
        },
        value: '<border-radius>',
    ...
    'column-rule-break': {
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'column-rule-break'],
                value: 'normal',
            },
            serialized: 'normal',
        },
                ...
                [
                    {
                        ...
                        start: 0,
                        types: ['<ident-token>', '<ident>', '<keyword>', '<color>', '<line-color-or-repeat>'],
                        value: 'currentcolor',
                    },
                ],
                ',',
                ['<line-color-list>', 'column-rule-color'],
            ),
            serialized: 'currentcolor',
        },
    ...
    'column-rule-inset-cap-end': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', '<inset-value>', 'column-rule-inset-cap-end'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'column-rule-inset-cap-start': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', '<inset-value>', 'column-rule-inset-cap-start'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'column-rule-inset-junction-end': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', '<inset-value>', 'column-rule-inset-junction-end'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'column-rule-inset-junction-start': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', '<inset-value>', 'column-rule-inset-junction-start'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
                ...
                [
                    {
                        ...
                        start: 0,
                        types: ['<ident-token>', '<ident>', '<keyword>', '<line-style>', '<line-style-or-repeat>'],
                        value: 'none',
                    },
                ],
                ',',
                ['<line-style-list>', 'column-rule-style'],
            ),
            serialized: 'none',
        },
    ...
    'column-rule-visibility-items': {
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'column-rule-visibility-items'],
                value: 'normal',
            },
            serialized: 'normal',
        },
                ...
                [
                    {
                        ...
                        start: 0,
                        types: ['<ident-token>', '<ident>', '<keyword>', '<line-width>', '<line-width-or-repeat>'],
                        value: 'medium',
                    },
                ],
                ',',
                ['<line-width-list>', 'column-rule-width'],
            ),
            serialized: 'medium',
        },
            ...
            parsed: list(
                [
                    ...
                    ),
                    {
                        ...
                        start: 0,
                        types: ['<ident-token>', '<ident>', '<keyword>', '<cursor-predefined>'],
                        value: 'auto',
                    },
                ],
                ' ',
    ...
    'event-trigger-name': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'event-trigger-name'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'flex-line-count': {
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<number-token>', '<integer>', 'flex-line-count'],
                value: 1,
            },
            serialized: '1',
        },
    ...
    'flow-from': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<custom-ident>', 'flow-from'],
                value: 'none',
            },
            serialized: 'none',
        },
                ...
                [
                    {
                        ...
                        start: 0,
                        types: ['<ident-token>', '<ident>', '<keyword>', '<generic-font-complete>', '<generic-font-family>'],
                        value: 'monospace',
                    },
                ],
                ',',
    ...
    'font-variant-alternates': {
        ...
        value: 'normal | stylistic(<font-feature-value-name>) || historical-forms || styleset(<font-feature-value-name>#) || character-variant(<font-feature-value-name>#) || swash(<font-feature-value-name>) || ornaments(<font-feature-value-name>) || annotation(<font-feature-value-name>)',
    },
    'font-variant-caps': {
        inherited: true,
        initial: {
    ...
    'frame-sizing': {
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'frame-sizing'],
                value: 'auto',
            },
            serialized: 'auto',
        },
    ...
    'image-animation': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'image-animation'],
                value: 'normal',
            },
            serialized: 'normal',
        },
    ...
    'interest-delay-end': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'interest-delay-end'],
                value: 'normal',
            },
            serialized: 'normal',
        },
    ...
    'interest-delay-start': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'interest-delay-start'],
                value: 'normal',
            },
            serialized: 'normal',
        },
    ...
    'justify-self': {
        ...
        value: 'auto | <overflow-position>? [normal | <self-position> | left | right] | stretch | <baseline-position> | anchor-center',
    },
    'left': {
        group: 'inset',
        initial: {
    ...
    'mask-border-outset': {
        initial: {
            parsed: list(
                ...
                ' ',
                ["<'border-image-outset'>", 'mask-border-outset'],
            ),
            serialized: '0',
        },
    ...
    'mask-border-source': {
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', "<'border-image-source'>", 'mask-border-source'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'path-length': {
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'path-length'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'row-rule-break': {
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'row-rule-break'],
                value: 'normal',
            },
            serialized: 'normal',
        },
    ...
    'row-rule-color': {
        initial: {
            parsed: list(
                ...
                ',',
                ['<line-color-list>', 'row-rule-color'],
            ),
            serialized: 'currentcolor',
        },
        value: '<line-color-list> | <auto-line-color-list>',
    ...
    'row-rule-inset-cap-end': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', '<inset-value>', 'row-rule-inset-cap-end'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'row-rule-inset-cap-start': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', '<inset-value>', 'row-rule-inset-cap-start'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'row-rule-inset-junction-end': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', '<inset-value>', 'row-rule-inset-junction-end'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'row-rule-inset-junction-start': {
        initial: {
            parsed: {
                types: ['<dimension-token>', '<dimension>', '<length>', '<length-percentage>', '<inset-value>', 'row-rule-inset-junction-start'],
                unit: 'px',
                value: 0,
            },
            serialized: '0px',
    ...
    'row-rule-style': {
        initial: {
            parsed: list(
                ...
                ',',
                ['<line-style-list>', 'row-rule-style'],
            ),
            serialized: 'none',
        },
        value: '<line-style-list> | <auto-line-style-list>',
    ...
    'row-rule-visibility-items': {
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'row-rule-visibility-items'],
                value: 'normal',
            },
            serialized: 'normal',
        },
    ...
    'row-rule-width': {
        initial: {
            parsed: list(
                ...
                ',',
                ['<line-width-list>', 'row-rule-width'],
            ),
            serialized: 'medium',
        },
        value: '<line-width-list> | <auto-line-width-list>',
    ...
    'rule-overlap': {
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'rule-overlap'],
                value: 'row-over-column',
            },
            serialized: 'row-over-column',
        },
    ...
    'scroll-axis-lock': {
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'scroll-axis-lock'],
                value: 'auto',
            },
            serialized: 'auto',
        },
    ...
    'timeline-trigger-name': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'timeline-trigger-name'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'trigger-scope': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'trigger-scope'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'view-transition-scope': {
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'view-transition-scope'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'window-drag': {
        ...
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<ident-token>', '<ident>', '<keyword>', 'window-drag'],
                value: 'none',
            },
            serialized: 'none',
        },
    ...
    'zoom': {
        initial: {
            parsed: {
                ...
                start: 0,
                types: ['<number-token>', '<number>', 'zoom'],
                value: 1,
            },
            serialized: '1',
        },
