 ...
 * @param {object} node
 * @returns {boolean}
 * @see {@link https://drafts.csswg.org/css-values-5/#non-strict-comma-containing-production}
 * @see {@link https://github.com/w3c/csswg-drafts/issues/11042}
 */
function isRestrictedCommaContainingValue(node) {
...
function matchCommaContainingValue(node, match) {
    ...
    if (isRestrictedCommaContainingValue(node)) {
