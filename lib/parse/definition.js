 ...
 * @param {object} [repeat]
 * @returns {object|void}
 * @see https://drafts.csswg.org/css-values-4/#component-multipliers
 */
 ...
 * @returns {object}
 */
function consumeSimpleBlock(definition) {
    const args = definition.consumeUntil(')')
    definition.consume()
    return { type: 'simple-block', value: args }
}
 ...
 * @param {object} [init]
 * @returns {object}
 * @see https://drafts.csswg.org/css-values-4/#value-defs
 */
