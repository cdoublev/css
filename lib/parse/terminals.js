...
const { parseDeclaration, parseDeclarationList, parseRuleList, parseStyleSheet, parseStyleBlock } = require('./syntax.js')
...
const terminals = {
    ...
    'declaration-list': parseDeclarationList,
    ...
    'rule-list': parseRuleList,
    'semitones': parseSemitones,
    'string': parseString,
    'style-block': parseStyleBlock,
