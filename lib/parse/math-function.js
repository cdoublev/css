 ...
 * @returns {object}
 *
 * If the node represents <type> produced by <type-percentage>, it returns
 * <type> as the resolution type and <type-percentage> as the context type,
 * otherwise it only returns <type> as the context type.
 */
function getNumericContextTypes({ definition: { name: type }, parent }) {
    ...
    if (
        ...
        return { contextType: `${type.slice(0, -1)}-percentage>`, resolutionType: type }
    }
