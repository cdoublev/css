 ...
 * @param {string} [char]
 * @returns {boolean}
 * @see https://drafts.csswg.org/css-syntax-3/#digit
 */
 ...
 * @param {string} [char]
 * @returns {boolean}
 * @see https://drafts.csswg.org/css-syntax-3/#hex-digit
 */
function isHex(char = '') {
 ...
 * @param {string} [char]
 * @returns {boolean}
 * @see https://drafts.csswg.org/css-syntax-3/#identifier-start-code-point
 */
 ...
 * @param {string} [char]
 * @returns {boolean}
 * @see https://drafts.csswg.org/css-syntax-3/#non-ascii-code-point
 */
 ...
 * @param {string} [char]
 * @returns {boolean}
 * @see https://drafts.csswg.org/css-syntax-3/#identifier-code-point
 */
 ...
 * @param {string} [char]
 * @returns {boolean}
 * @see https://drafts.csswg.org/css-syntax-3/#whitespace
 */
 ...
 * @param {string} [second]
 * @returns {boolean}
 * @see https://drafts.csswg.org/css-syntax-3/#starts-with-a-valid-escape
 */
 ...
 * @param {string} [third]
 * @returns {boolean}
 * @see https://drafts.csswg.org/css-syntax-3/#starts-with-a-number
 */
 ...
 * @param {string} string
 * @returns {number}
 * @see https://drafts.csswg.org/css-syntax-3/#convert-string-to-number
 *
...
/**
 * @param {object} chars
 * @see https://drafts.csswg.org/css-syntax-3/#consume-remnants-of-bad-url
 */
 ...
 * @param {object} chars
 * @returns {object}
 * @see https://drafts.csswg.org/css-syntax-3/#consume-ident-like-token
 */
...
function consumeNumber(chars) {
    ...
    if (startsWithDecimal(chars.next(), chars.next(2))
        ...
        type = 'number'
        representation += chars.consume() + chars.consume()
        while (isDigit(chars.next())) {
            representation += chars.consume()
        }
    }
 ...
 * @param {object} chars
 * @returns {object}
 * @see https://drafts.csswg.org/css-syntax-3/#consume-numeric-token
 */
function consumeNumeric(chars) {
    ...
    if (startsWithIdentifier(chars.next(), chars.next(2), chars.next(3))) {
        const unit = consumeIdentifier(chars).toLowerCase()
        return { type: new Set(['dimension']), unit, value }
    }
    if (chars.consume('%')) {
 ...
 * @param {object} chars
 * @returns {object}
 * @see https://drafts.csswg.org/css-syntax-3/#consume-url-token
 */
function consumeUrl(chars) {
    const url = { type: new Set(['url-token']), value: '' }
    ...
    for (const currentChar of chars) {
        ...
        if (isWhitespace(currentChar)) {
            ...
            consumeBadUrl(chars)
            url.type.add('bad-url-token')
            url.value = ''
            return url
        }
        // TODO: handle non-printable characters in URL
...
/**
 * @param {object} chars
 * @see https://drafts.csswg.org/css-syntax-3/#consume-comments
 */
 ...
 * @see https://drafts.csswg.org/css-syntax-3/#consume-token
 */
function consumeToken(chars) {
    ...
    if (currentChar === '#') {
        if (isIdentifierChar(chars.next()) || startsWithEscaped(chars.next(), chars.next(2))) {
            const hash = { type: new Set(['hash-token']) }
            if (startsWithIdentifier(chars.next(), chars.next(2), chars.next(3))) {
                hash.type.add('id')
            }
 ...
 * @param {object} input
 * @returns {object[]}
 * @see https://drafts.csswg.org/css-syntax-3/#css-tokenize
 */
