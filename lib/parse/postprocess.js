 ...
 *
 * It represents the function with its identifier argument in lowercase.
 */
function postParseSupportsAtRule({ value, ...fn }) {
    return { ...fn, value: { ...value, value: toLowerCase(value.value) } }
}
 ...
 * It represents the function with its identifier argument in lowercase.
 */
function postParseSupportsEnvironmentVariable(fn) {
    const { value } = fn
