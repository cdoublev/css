 ...
 *
 * It represents the list items in the same order as specified.
 */
function postParseListToSpecifiedOrder(list) {
 ...
 * @see {@link https://svgwg.org/svg2-draft/painting.html#PaintOrderProperty}
 *
 * It represents the paint operations in the same order as specified.
 */
function postParsePaintOrder(paint) {
    return isList(paint) ? postParseListToSpecifiedOrder(paint) : paint
}
