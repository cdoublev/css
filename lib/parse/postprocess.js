 ...
 *
 * It represents the radii in a whitespace separated list, to simplify further
 * processing.
 */
 ...
 *
 * It aborts parsing when a size calculation does not match <length-percentage>.
 *
 ...
 *
 * It represents the log with its base equal to the base of natural logarithms
 * and the preceding comma, replaced with omitted values.
 */
 ...
 *
 * It aborts parsing the keyword when it is not allowed in the context.
 */
 ...
 *
 * It aborts parsing when the argument is neither a <dashed-ident> or a defined
 ...
 *
 * It aborts parsing when some class names is a reserved keyword in the context.
 */
