...
function parseAnimationTrigger(triggers, longhands) {
    ...
    for (const trigger of triggers) {
        let [behavior, timeline, [start, end, exitStart, exitEnd] = []] = trigger.flat()
        if (isOmitted(behavior)) {
            behavior = initial.get('animation-trigger-behavior')
        }
        ...
        declarations.get('animation-trigger-behavior').push(behavior)
