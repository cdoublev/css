...
/**
 * @param {CSSRuleImpl|CSSStyleSheetImpl|null|...string} [value] CSSOM value or rule name(s)
 * @returns {object[]}
 */
function createContext(...rules) {
    const [value] = rules
    // Rule name(s)
    ...
    return { globals: new Map([['namespaces', new Set]]), trees: [] }
}
