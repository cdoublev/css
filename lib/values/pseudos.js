...
const indexed = {
    functions: {
        'nth-child': '<a-n-plus-b> [of <complex-real-selector-list>]?',
        'nth-col': '<a-n-plus-b>',
        'nth-last-child': '<a-n-plus-b> [of <complex-real-selector-list>]?',
        'nth-last-col': '<a-n-plus-b>',
        'nth-last-of-type': '<a-n-plus-b>',
        'nth-of-page': '<a-n-plus-b>',
        'nth-of-type': '<a-n-plus-b>',
    },
    identifiers: [
        'first-child',
        'first-of-page',
...
const form = {
    ...
    elements: {
        ...
        'field-separator': {},
        'field-text': {
            elements: ['field-component', 'field-separator'],
        },
        'reveal-icon': {},
    },
}
