...
module.exports = {
    ...
    'margin-rule': "@top-left-corner '{' <declaration-list> '}' | @top-left '{' <declaration-list> '}' | @top-center '{' <declaration-list> '}' | @top-right '{' <declaration-list> '}' | @top-right-corner '{' <declaration-list> '}' | @bottom-left-corner '{' <declaration-list> '}' | @bottom-left '{' <declaration-list> '}' | @bottom-center '{' <declaration-list> '}' | @bottom-right '{' <declaration-list> '}' | @bottom-right-corner '{' <declaration-list> '}' | @left-top '{' <declaration-list> '}' | @left-middle '{' <declaration-list> '}' | @left-bottom '{' <declaration-list> '}' | @right-top '{' <declaration-list> '}' | @right-middle '{' <declaration-list> '}' | @right-bottom '{' <declaration-list> '}'",
    'marker-ref': '<url>',
    ...
    'pseudo-class-selector': "':' <ident> | ':' <function> <any-value> ')'",
    ...
    'urange': "u '+' <ident> '?'* | u <dimension> '?'* | u <number> '?'* | u <number> <dimension> | u <number> <number> | u '+' '?'+",
    'uri': '<url>',
