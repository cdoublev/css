...
module.exports = {
    ...
    '<bg-position>': 'left | center | right | top | bottom | start | end | <length-percentage> | [left | center | right | x-start | x-end | <length-percentage>] [top | center | bottom | y-start | y-end | <length-percentage>] | [center | [left | right | x-start | x-end] <length-percentage>?] && [center | [top | bottom | y-start | y-end] <length-percentage>?] | [center | [start | end] <length-percentage>?] [center | [start | end] <length-percentage>?]',
    '<bg-size>': '[<length-percentage [0,∞]> | auto]{1,2} | cover | contain',
    '<blend-mode>': 'normal | multiply | screen | overlay | darken | lighten | color-dodge | color-burn | hard-light | soft-light | difference | exclusion | hue | saturation | color | luminosity',
    '<blur()>': 'blur(<length>?)',
    '<bool-and>': 'and <bool-in-parens>',
    '<bool-in-parens>': '(<boolean>) | <bool-test> | <general-enclosed>',
    '<bool-not>': 'not <bool-in-parens>',
    '<bool-or>': 'or <bool-in-parens>',
    '<boolean-without-or>': '<bool-not> | <bool-in-parens> <bool-and>*',
    '<boolean>': '<bool-not> | <bool-in-parens> [<bool-and>* | <bool-or>*]',
    ...
    '<calc-size-basis>': '<intrinsic-size-keyword> | percentage | <calc-size()> | any | <calc-sum>',
    ...
    '<dimension-unit>': "'%' | deg | grad | rad | turn | db | fr | hz | khz | cap | ch | cm | cqb | cqh | cqi | cqmax | cqmin | cqw | dvb | dvh | dvi | dvmax | dvmin | dvw | em | ex | ic | in | lh | lvb | lvh | lvi | lvmax | lvmin | lvw | mm | pc | pt | px | q | rcap | rch | rem | rex | ric | rlh | svb | svh | svi | svmax | svmin | svw | vb | vh | vi | vmax | vmin | vw | dpcm | dpi | dppx | x | st | ms | s",
    ...
    '<linear()>': 'linear(<linear-stop-list>)',
    ...
    '<syntax-component>': "<syntax-component-name> <syntax-multiplier>? | '<' transform-list '>'",
    '<syntax-multiplier>': "'#' | '+'",
    '<syntax-type>': 'angle | color | custom-ident | image | integer | length | length-percentage | number | percentage | resolution | string | time | url | transform-function',
