...
module.exports = {
    ...
    'sin()': 'sin(<calc-sum>)',
    'single-animation': '[auto | <time [0s,∞]>] || <easing-function> || <time> || <single-animation-iteration-count> || <single-animation-direction> || <single-animation-fill-mode> || <single-animation-play-state> || [none | <keyframes-name>] || <single-animation-timeline>',
