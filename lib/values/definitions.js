...
module.exports = {
    ...
    'anchor-side': 'top | left | right | bottom | start | end | self-start | self-end | <percentage> | center',
    ...
    'arc-command': 'arc <by-to> <coordinate-pair> of <length-percentage>{1,2} [<arc-sweep> || <arc-size> || rotate <angle>] | arc <by-to> <coordinate-pair> of <length-percentage>{1,2} [<arc-sweep> || <arc-size> || rotate <angle>]?',
    ...
    'css-wide-keyword': 'inherit | initial | revert | revert-layer | unset',
    ...
    'dimension-unit': '"%" | deg | grad | rad | turn | dB | fr | hz | khz | cap | ch | cm | dvb | dvh | dvi | dvmax | dvmin | dvw | em | ex | ic | in | lh | lvb | lvh | lvi | lvmax | lvmin | lvw | mm | pc | pt | px | q | rcap | rch | rem | rex | ric | rlh | svb | svh | svi | svmax | svmin | svw | vb | vh | vi | vmax | vmin | vw | dpcm | dpi | dppx | x | st | ms | s',
