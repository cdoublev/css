...
import definitions from './context-sensitive.js'
...
export default {
    ...
    '<attr-unit>': "'%' | deg | grad | rad | turn | db | fr | hz | khz | cm | in | mm | pc | pt | px | q | cqw | cqh | cqi | cqb | cqmin | cqmax | cap | ch | em | ex | ic | lh | rcap | rch | rem | rex | ric | rlh | dvb | dvh | dvi | dvmax | dvmin | dvw | lvb | lvh | lvi | lvmax | lvmin | lvw | svb | svh | svi | svmax | svmin | svw | vb | vh | vi | vmax | vmin | vw | dpcm | dpi | dppx | x | st | ms | s",
