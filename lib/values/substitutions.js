 ...
 * @see {@link https://drafts.csswg.org/css-values-5/#funcdef-ident}
...
export const arbitrary = [
    { definition: '<dashed-function>', name: '<dashed-ident>', element: true },
    { definition: '<attr-args>', name: 'attr', element: true },
    { definition: '<env-args>', name: 'env' },
    { definition: '<ident-args>', name: 'ident' },
    { definition: '<if-args>', name: 'if' },
    { definition: '<inherit-args>', name: 'inherit', cascade: true },
    { definition: '<random-item-args>', name: 'random-item', element: true },
    { definition: '<var-args>', name: 'var', cascade: true },
]
 ...
 */
export const keywords = properties.all.value.split(' | ')
...
export const numeric = [
    ...
    { definition: '<calc-interpolate()>', name: 'calc-interpolate' },
 ...
 */
export const whole = [
    { definition: '<cycle()>', name: 'cycle', element: true, pending: true },
