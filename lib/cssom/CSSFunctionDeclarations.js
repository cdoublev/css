...
import Impl from "./CSSFunctionDeclarations-impl.js";
...
const interfaceName = "CSSFunctionDeclarations";
...
const convert = (globalObject, value, { context = "The provided value" } = {}) => {
  ...
  throw new globalObject.TypeError(`${context} is not of type 'CSSFunctionDeclarations'.`);
};
...
function makeWrapper(globalObject, newTarget) {
  ...
  if (!utils.isObject(proto)) {
    proto = globalObject[ctorRegistrySymbol]["CSSFunctionDeclarations"].prototype;
  }
...
const install = (globalObject, globalNames) => {
  ...
  class CSSFunctionDeclarations extends globalObject.CSSRule {
    constructor() {
    ...
    get style() {
      ...
      if (!is(esValue)) {
        throw new globalObject.TypeError(
          "'get style' called on an object that is not a valid instance of CSSFunctionDeclarations."
        );
      }
    ...
    set style(V) {
      ...
      if (!is(esValue)) {
        throw new globalObject.TypeError(
          "'set style' called on an object that is not a valid instance of CSSFunctionDeclarations."
        );
      }
  ...
  Object.defineProperties(CSSFunctionDeclarations.prototype, {
    style: { enumerable: true },
    [Symbol.toStringTag]: { value: "CSSFunctionDeclarations", configurable: true }
  });
  ctorRegistry[interfaceName] = CSSFunctionDeclarations;
