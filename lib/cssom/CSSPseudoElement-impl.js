...
export default class CSSPseudoElementImpl {
     ...
     */
    constructor(globalObject, args, { element, parent, selectorText, type }) {
    ...
    pseudo(type) {
        ...
        const selectorText = parseGrammar(type, '<pseudo-element-selector>', this._globalObject)
        ...
        return CSSPseudoElement.createImpl(this._globalObject, undefined, privateData)
    }
}
