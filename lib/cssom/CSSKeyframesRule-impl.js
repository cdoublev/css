...
import { SET_INVALID_NAME_ERROR, create as error } from '../error.js'
import { insertRule, parseGrammar, removeRule } from '../parse/parser.js'
import { serializeCSSComponentValue, serializeCSSComponentValueList } from '../serialize.js'
...
export default class CSSKeyframesRuleImpl extends CSSRuleImpl {
    ...
    constructor(globalObject, args, privateData) {
        ...
        const rules = parseGrammar(value, { associatedToken: '{', type: 'block', value: node.definition.value }, { ...node, value: this }, 'lazy').value
        this._name = prelude
