...
export default class CSSFunctionRuleImpl extends CSSGroupingRuleImpl {
    ...
    constructor(globalObject, args, privateData) {
        ...
        const { node, prelude: [{ name, value: parameters }, returnType], value } = privateData
        const rules = parseGrammar(value, { associatedToken: '{', type: 'block', value: node.definition.value }, { ...node, value: this }, 'lazy').value.map(rule => {
