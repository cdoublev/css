...
import Impl from "./CSSPageDeclarations-impl.js";
...
const interfaceName = "CSSPageDeclarations";
...
const convert = (globalObject, value, { context = "The provided value" } = {}) => {
  ...
  throw new globalObject.TypeError(`${context} is not of type 'CSSPageDeclarations'.`);
};
...
function makeWrapper(globalObject, newTarget) {
  ...
  if (!utils.isObject(proto)) {
    proto = globalObject[ctorRegistrySymbol]["CSSPageDeclarations"].prototype;
  }
...
const install = (globalObject, globalNames) => {
  ...
  class CSSPageDeclarations extends globalObject.CSSRule {
    constructor() {
    ...
    get style() {
      ...
      if (!is(esValue)) {
        throw new globalObject.TypeError(
          "'get style' called on an object that is not a valid instance of CSSPageDeclarations."
        );
      }
    ...
    set style(V) {
      ...
      if (!is(esValue)) {
        throw new globalObject.TypeError(
          "'set style' called on an object that is not a valid instance of CSSPageDeclarations."
        );
      }
  ...
  Object.defineProperties(CSSPageDeclarations.prototype, {
    style: { enumerable: true },
    [Symbol.toStringTag]: { value: "CSSPageDeclarations", configurable: true }
  });
  ctorRegistry[interfaceName] = CSSPageDeclarations;

  Object.defineProperty(globalObject, interfaceName, {
    configurable: true,
    writable: true,
    value: CSSPageDeclarations
  });
};
