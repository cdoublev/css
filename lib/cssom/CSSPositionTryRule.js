...
import Impl from "./CSSPositionTryRule-impl.js";
...
const interfaceName = "CSSPositionTryRule";
...
const convert = (globalObject, value, { context = "The provided value" } = {}) => {
  ...
  throw new globalObject.TypeError(`${context} is not of type 'CSSPositionTryRule'.`);
};
...
function makeWrapper(globalObject, newTarget) {
  ...
  if (!utils.isObject(proto)) {
    proto = globalObject[ctorRegistrySymbol]["CSSPositionTryRule"].prototype;
  }
...
const install = (globalObject, globalNames) => {
  ...
  class CSSPositionTryRule extends globalObject.CSSRule {
    constructor() {
    ...
    get name() {
      ...
      if (!is(esValue)) {
        throw new globalObject.TypeError(
          "'get name' called on an object that is not a valid instance of CSSPositionTryRule."
        );
      }
    ...
    get style() {
      ...
      if (!is(esValue)) {
        throw new globalObject.TypeError(
          "'get style' called on an object that is not a valid instance of CSSPositionTryRule."
        );
      }
    ...
    set style(V) {
      ...
      if (!is(esValue)) {
        throw new globalObject.TypeError(
          "'set style' called on an object that is not a valid instance of CSSPositionTryRule."
        );
      }
  ...
  Object.defineProperties(CSSPositionTryRule.prototype, {
    ...
    [Symbol.toStringTag]: { value: "CSSPositionTryRule", configurable: true }
  });
  ctorRegistry[interfaceName] = CSSPositionTryRule;
