...
import Impl from "./CSSMarginRule-impl.js";
...
const interfaceName = "CSSMarginRule";
...
const convert = (globalObject, value, { context = "The provided value" } = {}) => {
  ...
  throw new globalObject.TypeError(`${context} is not of type 'CSSMarginRule'.`);
};
...
function makeWrapper(globalObject, newTarget) {
  ...
  if (!utils.isObject(proto)) {
    proto = globalObject[ctorRegistrySymbol]["CSSMarginRule"].prototype;
  }
...
const install = (globalObject, globalNames) => {
  ...
  class CSSMarginRule extends globalObject.CSSRule {
    constructor() {
    ...
    get name() {
      ...
      if (!is(esValue)) {
        throw new globalObject.TypeError(
          "'get name' called on an object that is not a valid instance of CSSMarginRule."
        );
      }
    ...
    get style() {
      ...
      if (!is(esValue)) {
        throw new globalObject.TypeError(
          "'get style' called on an object that is not a valid instance of CSSMarginRule."
        );
      }
    ...
    set style(V) {
      ...
      if (!is(esValue)) {
        throw new globalObject.TypeError(
          "'set style' called on an object that is not a valid instance of CSSMarginRule."
        );
      }
  ...
  Object.defineProperties(CSSMarginRule.prototype, {
    ...
    [Symbol.toStringTag]: { value: "CSSMarginRule", configurable: true }
  });
  ctorRegistry[interfaceName] = CSSMarginRule;
