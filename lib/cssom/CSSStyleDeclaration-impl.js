...
class CSSStyleDeclarationImpl {
    ...
    constructor(globalObject, args, privateData) {
        ...
        if (ownerNode && !computed) {
            ...
            if (value) {
                this._declarations = parseBlockContents(value, parentRule ?? ownerNode).declarations
            }
        }
    }
    ...
    set cssText(value) {
        ...
        this._declarations = parseBlockContents(value, this.parentRule ?? this.ownerNode).declarations
        this._update()
    }
    ...
    _change(name, value, namespace) {
        ...
        this._declarations = value ? parseBlockContents(value, this.parentRule ?? this.ownerNode).declarations : []
    }
