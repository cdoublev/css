...
class CSSStyleDeclarationImpl {
    ...
    constructor(globalObject, args, privateData) {
        ...
        if (ownerNode && !computed) {
            ...
            if (value) {
                this._declarations = parseBlockContents(value, parentRule ?? ownerNode)[0] ?? []
            }
        }
    }
    ...
    set cssText(value) {
        ...
        this._declarations = parseBlockContents(value, this.parentRule ?? this.ownerNode)[0] ?? []
        this._update()
    }
    ...
    _change(name, value, namespace) {
        ...
        this._declarations = value ? parseBlockContents(value, this.parentRule ?? this.ownerNode)[0] ?? [] : []
    }
