...
const { getDeclarationsInSpecifiedOrder, parseCSSDeclarationBlock, parseCSSDeclarationValue, setCSSDeclaration } = require('../parse/syntax.js')
...
class CSSStyleDeclarationImpl {
     ...
     *
     * `privateData.declarations` (CSS declarations) are specified as a "list"
     * only in the procedure for `Window.getComputedStyle()`, but using a `Map`
     * makes the code more readable, probably more performant, and is probably
     * more appropriate to represent a list of declarations which should not
     * include more than one declaration with the same property.
     */
    ...
    setProperty(name, value, priority = '') {
        ...
        const componentValueList = parseCSSDeclarationValue(value, name)
