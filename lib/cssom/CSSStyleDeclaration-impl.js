...
import { getDeclarationName, parseDeclarationList, parseDestructuredDeclaration } from '../parse/parser.js'
...
export default class CSSStyleDeclarationImpl {
    ...
    constructor(globalObject, args, privateData) {
        ...
        if (ownerNode && !computed) {
            ...
            if (value) {
                this._declarations = parseDeclarationList(value, ownerNode)
            }
        }
    }
    ...
    _change(name, value, namespace) {
        ...
        this._declarations = value ? parseDeclarationList(value, this.parentRule ?? this._ownerNode) : []
    }
