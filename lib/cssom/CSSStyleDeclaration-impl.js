...
class CSSStyleDeclarationImpl {
    ...
    set cssText(value) {
        ...
        getDeclarationsInSpecifiedOrder(parseCSSDeclarationBlock(value, new Parser(this.parentRule)))
     ...
     * name against the context in `Parser.parseDeclaration()`.
     */
    setProperty(name, value, priority = '') {
        ...
        const parser = new Parser(this.parentRule)
