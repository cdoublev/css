...
class CSSNestingRule extends CSSRuleImpl {
    ...
    constructor(globalObject, args, privateData) {
        ...
        parseCSSStyleBlock(value, definition.value, this).forEach(statement =>
    ...
    /**
     * @see {@link https://drafts.csswg.org/css-nesting-1/#dom-cssnestingrule-cssrules}
     */
    get cssRules() {
        return CSSRuleList.create(this._globalObject, undefined, { rules: this._rules })
    }
