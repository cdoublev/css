...
const topLevelRules = [
            ...
            rules: [
                {
                    ...
                    type: 'rule',
                    value: {
                        descriptors: { '*': '<font-feature-index [0,∞]>' },
                        name: '<declaration-list>',
                        type: 'arbitrary',
                    },
                },
                {
                    ...
                    type: 'rule',
                    value: {
                        descriptors: { '*': '<font-feature-index [0,99]> <font-feature-index>' },
                        name: '<declaration-list>',
                        type: 'arbitrary',
                    },
                },
                ...
                },
                {
                    ...
                    type: 'rule',
                    value: {
                        descriptors: { '*': '<font-feature-index [0,20]>+' },
                        name: '<declaration-list>',
                        type: 'arbitrary',
                    },
                },
    ...
    functionRule,
    /**
     * @see {@link https://drafts.csswg.org/css-cascade-6/#at-ruledef-import}
     */
    {
        cssom: 'CSSImportRule',
        name: '@import',
            ...
            rules: [
                {
                    ...
                    value: {
                        descriptors: {
                            'page-margin-safety': descriptors['@page']['page-margin-safety'],
                        },
                        name: '<declaration-list>',
