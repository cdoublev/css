...
const { hasPendingSubstitution, isCalculationOperator, isInfinityOrNaN, isNumeric, isOmitted } = require('./utils/value.js')
 ...
 */
function serializeCSSComponentValueList(list) {
    let separator = list.separator ?? ' '
    switch (separator) {
        case ' ':
        case '':
            break
