...
const { areEqual, areEqualSides, isCalcOperatorNode, isInfinityOrNaN, isNumeric } = require('./values/validation.js')
 ...
 * @returns {string}
 * @see https://drafts.csswg.org/cssom/#ref-for-alphavalue-def
 * @see https://drafts.csswg.org/css-color-4/#serializing-alpha-values
 */
 ...
 * @param {object} angle
 * @returns {string}
 * @see https://drafts.csswg.org/cssom/#ref-for-angle-value
 */
 ...
 * @param {object[][]} radii
 * @returns {string}
 * @see https://drafts.csswg.org/css-backgrounds/#propdef-border-radius
 */
 ...
 * @param {object} color
 * @returns {string}
 * @see https://www.w3.org/TR/css-color-4/#serializing-color-values
 *
 ...
 *
 * User agents store an alpha value as an 8 bit unsigned integer only when given
 * as a percentage in a color function. The alpha value should have been parsed
 * to `100%` when omitted, but it will be serialized identically to `1`.
 */
 ...
 * @returns {string}
 * @see https://drafts.csswg.org/cssom/#ref-for-typedef-counter
 */
 ...
 * @returns {string}
 * @see https://drafts.csswg.org/cssom/#ref-for-value-def-identifier
 */
 ...
 * @returns {string}
 * @see https://drafts.csswg.org/cssom/#ref-for-frequency-value
 */
 ...
 * @param {object[]} args
 * @returns {string}
 * @see https://drafts.csswg.org/css-shapes-1/#funcdef-inset
 */
 ...
 * @param {object} length
 * @returns {string}
 * @see https://drafts.csswg.org/cssom/#ref-for-length-value
 */
 ...
 * @returns {string}
 * @see https://drafts.csswg.org/css-values-4/#serialize-a-calculation-tree
 */
 ...
 * @param {boolean} [forComputedOrLater]
 * @returns {string}
 * @see https://drafts.csswg.org/css-values-4/#serialize-a-math-function
 */
 ...
 * @param {object} number
 * @returns {string}
 * @see https://drafts.csswg.org/cssom/#ref-for-integer-value
 * @see https://drafts.csswg.org/cssom/#ref-for-number-value
 *
 ...
 * @returns {string}
 * @see https://drafts.csswg.org/cssom/#ref-for-percentage-value
 */
 ...
 * @see https://drafts.csswg.org/css-shapes-1/#basic-shape-serialization
 * @see https://github.com/w3c/csswg-drafts/issues/2274
 */
 ...
 * @returns {string}
 * @see https://drafts.csswg.org/cssom/#ref-for-ratio-value
 */
 ...
 * @returns {string}
 * @see https://drafts.csswg.org/cssom/#ref-for-resolution-value
 */
 ...
 * @param {object} string
 * @returns {string}
 * @see https://drafts.csswg.org/cssom/#ref-for-string-value
 */
 ...
 * @param {object} time
 * @returns {string}
 * @see https://drafts.csswg.org/cssom/#ref-for-time-value
 */
 ...
 * @returns {string}
 * @see https://drafts.csswg.org/cssom/#ref-for-url-value
 */
...
function simplifyBorder(border) {
    ...
    for (const [i, component] of border.entries()) {
        ...
        if (top) {
            if (areEqual(top, component, true)) {
                continue
            }
            return ['']
        }
...
function simplifySides(sides) {
    let { length } = sides
    while (length-- > 1 && areEqualSides(sides[length], sides[length - 2] ?? sides[0])) {
...
function representDeclarationValue({ input, name, value }) {
    ...
    if (isShorthand) {
        ...
        if (cssWideKeyword) {
            ...
            if (value.every(component => areEqual(component, cssWideKeyword))) {
