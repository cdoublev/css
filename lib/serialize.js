...
function representRuleInset(declarations, longhands, shorthand) {
    ...
    if (shorthand.endsWith('rule-inset')) {
        const [edgeStart, edgeEnd, interiorStart, interiorEnd] = values
        if (edgeStart === interiorStart && edgeEnd === interiorEnd) {
        ...
        if (edgeStart === edgeEnd) {
            if (interiorStart === interiorEnd) {
                return `${edgeStart} / ${interiorStart}`
            }
            return `${edgeStart} / ${interiorStart} ${interiorEnd}`
        }
        if (interiorStart === interiorEnd) {
            return `${edgeStart} ${edgeEnd} / ${interiorStart}`
        }
        return `${edgeStart} ${edgeEnd} / ${interiorStart} ${interiorEnd}`
    }
