...
import { isList } from '../values/value.js'
...
export default function match(condition, globalObject) {
    ...
    for (const type of types) {
        switch (type) {
            ...
            case '<supports-named-feature-fn>':
            ...
            case '<supports-env-fn>':
                return !value.value.startsWith('--') || states.get(globalObject).environmentVariables.has(value.value)
            default:
                return false
        }
    }
