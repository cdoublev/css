...
import { isBlock, isFunction, isNumeric, isOmitted } from '../values/value.js'
...
function resolveValue(value) {
    // Resolved calculation function
    if (isFunction(value)) {
        return isNumeric(value.value, { resolved: true }) ? value.value.value : null
    }
