 ...
 * @returns {object}
 */
function createContext(tree, { elementCache = new Map, root = tree.getRootNode({}), ...context } = {}) {
    return { elementCache, root, ...context }
}
...
function matchTreesAgainstSelectors(trees, selectors, context, options) {
    ...
    // Normal: get matches by traversing the trees
