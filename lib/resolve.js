...
function getComputedLength(value, element, property) {
    switch (value.unit) {
        ...
        case 'cqb': {
            const container = findAncestor(element, element => isContainer(element, 'size'))
            if (container) {
                const writingMode = getComputedValue('writing-mode', element)
        ...
        case 'cqh': {
            ...
            const container = findAncestor(element, element => isContainer(element, containerType))
            if (container) {
        ...
        case 'cqi': {
            const container = findAncestor(element, element => isContainer(element, 'inline-size'))
            if (container) {
                const writingMode = getComputedValue('writing-mode', element)
