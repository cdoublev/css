 ...
 */
function getPreferredColorScheme({ ownerDocument: { defaultView } }) {
    if (defaultView?.frameElement) {
        return getElementColorScheme(defaultView.frameElement)
    }
    return null
}
...
function getPageColorScheme(element) {
    return getUsedColorScheme(
        ...
        getPreferredColorScheme(element))
}
...
function getElementColorScheme(element) {
    ...
    return getUsedColorScheme(
        getUASupportedColorScheme(element),
        support,
        getPreferredColorScheme(element))[0]
}
